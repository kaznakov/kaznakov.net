...
(function () {
  ...
  const dict = {
    en: {
      ...
      "projects.modal.project1.description": "AWOS Display.",
      "projects.modal.project1.link": "In progress",
      "projects.modal.project2.title": "MIRANDA chatbot",
      "projects.modal.project2.description": "MIRANDA chatbot.",
      "projects.modal.project2.link": "In progress",
      "projects.modal.project3.title": "ScanYOmail",
      "projects.modal.project3.description": "Scan your mail.",
      ...
      "projects.modal.project5.description": "Fast-paced interactive mini-game focused on observation and reaction.",
      "projects.modal.project5.link": "In progress",
      "projects.modal.project6.title": "Walk",
      "projects.modal.project6.description": "Urban walking companion with routes, challenges, and progress tracking.",
    ...
    ru: {
      ...
      "projects.modal.project1.title": "AWOS Display",
      "projects.modal.project1.description": "AWOS Display.",
      "projects.modal.project1.link": "В разработке",
      "projects.modal.project2.title": "Чат-бот Миранда",
      "projects.modal.project2.description": "AI-ассистент с разными ролями.",
      "projects.modal.project2.link": "www.kaznakov.net",
      "projects.modal.project3.title": "ScanYOmail",
      "projects.modal.project3.description": "Сканируй, сортируй, отслеживай.",
      ...
      "projects.modal.project5.title": "Where is the Fly?",
      "projects.modal.project5.description": "Динамичная мини-игра на внимательность и скорость реакции.",
      "projects.modal.project5.link": "В разработке",
      "projects.modal.project6.title": "Walk",
      "projects.modal.project6.description": "Городской помощник для прогулок с маршрутами и трекингом прогресса.",
